...
require_once("./minecraft_query.class.php");
	...
	<body>
		<div id="container">
			...
			<div class="block">
				...
				<p>Minecraft server: <?=checkProcess("craftbukkit");?></p>
			</div>
			<div class="block">
				<h3>minecraft</h3>
				<p>Server is <?=checkProcess("craftbukkit");?></p>
				<p>Players online: 
				<?php
				$q = MinecraftQuery::query("localhost");
				echo $q["players"];
				?>
				</p>
			</div>
